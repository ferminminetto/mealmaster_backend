...
SECRET_KEY = 'django-insecure-v16&a!&+^@m9n4#9=i_l-yuo90ig0ydn9qt%q191m_bj1%exxw'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DJANGO_DB_NAME', 'videogame_graphq'),
        'USER': os.environ.get('DJANGO_DB_USER', 'food_planner'),
